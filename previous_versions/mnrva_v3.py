...
if __name__=='__main__':
    ...
    try:
        ...
        #fpath = 'rouge_testing_input_output/lyft_ebike_input'
        #fpath = 'large_article_group'
        #fpath='articles'
        #fpath='small_test'
        fpath = 'rouge_testing_input_output/D30002_inputs'
    ...
    #fw = open("rouge_testing_input_output/system/"+timestamp+"-.8-.05-.05_system.txt", 'w+')
    fw = open("rouge_testing_input_output/project/system/D30002_system.txt", 'w+')
    #fw = open("rouge_testing_input_output/articles_summary_02-articlepos.txt", 'w+')
    outputText = ""
    for o in output:
        outputText += o + '\n'
    fw.write(outputText)
